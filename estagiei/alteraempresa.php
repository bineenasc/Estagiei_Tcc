...
if ($_SESSION['perfil'] < 1) {
    echo "<script>alert('Você não possui acesso à essa página!');window.location='alteraempresa.php'</script>";
}
...
$sql_retrieve = "SELECT * FROM empresa WHERE idEmpresa = '$novocod'";
...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-md-8 order-md-1 bg-white mt-4 p-4 rounded-3">
            <form method='post' action='confaltempresa.php'>
                <input type="hidden" name="novo-idempresa" value="<?php echo $dado['idEmpresa']; ?>">
                <fieldset>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" value="<?php echo $dado['NomeResp']; ?>" class="form-control" name="novo-nomeresp" id="nomeresp" placeholder="Informe o sobrenome" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" value="<?php echo $dado['End']; ?>" class="form-control" name="novo-end" id="end" placeholder="Rua Orquídea Branca, 00" value="" required>
                        </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <input type="text" value="<?php echo $dado['CNPJ']; ?>" class="form-control" name="novo-cnpj" id="cnpj" placeholder="" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" value="<?php echo $dado['TelFixo']; ?>" class="form-control" name="novo-telfixo" id="telfixo" placeholder="35645789" value="" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" value="<?php echo $dado['CEP']; ?>" class="form-control" name="novo-cep" id="cep" placeholder="33564-000" value="" required>
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <a href="empresas_cadastradas.php" class="btn btn-danger">Cancelar</a>
