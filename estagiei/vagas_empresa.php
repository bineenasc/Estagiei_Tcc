    ...
    <div class='row'>
        <div class='col-12'>
            ...
            <?php 
                ...
                $sql = "SELECT * FROM vaga WHERE idEmpresa = $idempresa ORDER BY idVaga DESC";
                ...
                if($num_rows > 0){
                    while($dado = mysqli_fetch_assoc($res)){
                        ...
                        <div class = 'card-body'>
                                ...
                                <a class='btn btn-success' href='saiba_mais_vagaempresa.php?cod=".$dado['idVaga']."' >Detalhar Infos</a>
                                <a class='btn btn-warning' href='alteravaga.php?cod=".$dado['idVaga']."' >Editar</a>
                                <a class='btn btn-danger' href='excluivagaempresa.php?cod=".$dado['idVaga']."' >Excluir</a>
                    </div>                               
                                </div>";
                    }
                }else{
